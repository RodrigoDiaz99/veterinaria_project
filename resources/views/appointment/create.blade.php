<x-app-layout title="Cooper Wash | Agendar Cita">
    <div class="p-4">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form action="{{ route('appointment.store') }}" method="POST">
                ...
                @method('POST')
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="patient" autofocus required>
                            <option value="" hidden disabled>SELECCIONE MASCOTA</option>
                            @foreach ($pets as $pet)
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="type" required>
                            <option value="" hidden disabled>SELECCIONE TIPO</option>
                    ...
                    <div class=" mt-4 text-sm">
                        <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
                            ...
                            <div class="relative">
                                <input name="date" x-ref="date" hidden>
                                <input 
                                    type="text"
                                    readonly
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                            <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="dental" value="0" required>
                            <span class="ml-2">No</span>
                        </label>
                        <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                            <input type="radio" class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="dental" value="1" required>
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea class="resize-none block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-input focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="observations" placeholder="Alergias, comportamientos, etc."></textarea>
                </label>
                ...
                <div class="pt-6 flex justify-center">
                    <button type="submit" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green">
                        ...
                        <span class="pl-2">Agendar Cita</span>
                    </button>
                </div>
            </form>
        </div>
